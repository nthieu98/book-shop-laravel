		...
		<div class="span4">
			...
			<form method = "post">
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" id="inputEmail0" name = "inputEmail0" placeholder="Email">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword0">Password</label>
				<div class="controls">
				  <input type="password" class="span3"  id="inputPassword0" name = "inputPassword0" placeholder="Password">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
