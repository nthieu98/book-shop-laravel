...
<!-- Sidebar end=============================================== -->
    ...
    <div class="control-group">
			<label class="control-label" for="inputUsername">Tên tài khoản <sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="inputUsername" name ="inputUsername" placeholder="Tên tài khoản">
			</div>
     </div>
     <div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="inputFullname">Họ và tên <sup>*</sup></label>
			<div class="controls">
			  <input type="text" id="inputFullname" name = "inputFullname" placeholder="Họ và tên">
			</div>
     </div>
     <div class="control-group">
		<label class="control-label">Giới tính <sup>*</sup></label>
		<div class="controls">
		<select class="span1" id = "male" name = "male">
			<option value="">-</option>
    ...
    <div class="control-group">
			<label class="control-label" for="inputBirthday">Ngày sinh<sup>*</sup></label>
			<div class="controls">
			  <input type="date" id="inputBirthday" name = "inputBirthday" placeholder="">
			</div>
     </div>
     <div class="control-group">
		<div class="control-group">
    ...
    <div class="control-group">
		<label class="control-label" for="inputPhoneNumber">Số điện thoại <sup>*</sup></label>
		<div class="controls">
		  <input type="text" id="inputPhoneNumber" name = "inputPhoneNumber" placeholder="Số điện thoại">
		</div>
    </div>
	...
	<div class="control-group">
			<div class="controls">
				...
				{!!csrf_field()!!}
				<button class="btn btn-large" type="submit" value="">Register</button>
			</div>
		</div>		
	</form>
</div>
