      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit-product/'.$productDetails->productId) }}" name="edit_product" id="edit_product" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="product_name" id="product_name" value="{{ $productDetails->productName }}">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Product Quantity</label>
                <div class="controls">
                  <input type="number" name="product_quantity" id="product_quantity" value="{{ $productDetails->productQuantity }}">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Product Price</label>
                <div class="controls">
                  <input type="number" name="product_price" id="product_price" value="{{ $productDetails->productPrice }}">
                </div>
              </div>
              <!-- <div class="control-group">
                      ...
                      <tr>
                        <td>
                          ...
                          @if(!empty($productDetails->productImage))
                            <input type="hidden" name="current_image" value="{{ $productDetails->productImage }}"> 
                          @endif
                        </td>
                        <td>
                          @if(!empty($productDetails->productImage))
